...
from Raya import TOKEN, bot, dp
from Raya.config import get_bool_key, get_list_key
from Raya.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
...
if get_bool_key("LOAD_MODULES"):
    ...
    for module_name in modules:
        ...
        imported_module = import_module("Raya.modules." + module_name)
...
import_module("Raya.modules.pm_menu")
# Import misc stuff
import_module("Raya.utils.exit_gracefully")
if not get_bool_key("DEBUG_MODE"):
    import_module("Raya.utils.sentry")
