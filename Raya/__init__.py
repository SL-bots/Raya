...
from Raya.config import get_bool_key, get_int_key, get_list_key, get_str_key
from Raya.services.telethon import tbot
from Raya.utils.logger import log
from Raya.versions import Raya_VERSION

log.info("----------------------")
log.info("|      Raya      |")
log.info("----------------------")
log.info("Version: " + Raya_VERSION)
