...
from Raya import BOT_USERNAME, dp
from Raya.config import get_bool_key
from Raya.modules.error import parse_update
from Raya.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("Raya.utils.filters." + module_name)
