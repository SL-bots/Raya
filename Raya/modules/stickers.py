...
from Raya.services.events import register as Raya
...
async def _(event):
    ...
    packshortname = f"Raya_stickers_{userid}"
    kanga = await event.reply("Hello, This Sticker Looks Noice. Mind if Raya steal it")
    ...
    if is_a_s:
        ...
        packshortname = f"Raya_animated_{userid}"
