...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(
        InlineKeyboardButton(strings["crowdin_btn"], url="https://t.me/SLBotsOfficial")
    )
    if edit:
...
__help__ = """
This module is dedicated towards utlising Raya's localization feature! You can also <a href='https://crowdin.com/project/Raya'>contribute</a> for improving localization in Raya!
...
Raya will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
