# Copyright (C) 2018 - 2020 TRTECHGUIDE. All rights reserved. Source code available under the AGPL.
# Copyright (C) 2021 SLBotsOfficial
# Copyright (C) 2020 Tharuk Renuja
...
/warns (?user)
Use this command to know number of warns and information about warns you got so far in the chat. To use yourself you doesn't require user argument.If any issuses please report at @SLBotsOfficial.
"""
