...
async def kick_user_cmd(message, chat, user, args, strings):
    ...
    if user_id == BOT_ID:
        await message.reply(strings["kick_Raya"])
        return
...
async def mute_user_cmd(message, chat, user, args, strings):
    ...
    if user_id == BOT_ID:
        await message.reply(strings["mute_Raya"])
        return
...
async def unmute_user_cmd(message, chat, user, strings):
    ...
    if user_id == BOT_ID:
        await message.reply(strings["unmute_Raya"])
        return
...
async def ban_user_cmd(message, chat, user, args, strings):
    ...
    if user_id == BOT_ID:
        await message.reply(strings["ban_Raya"])
        return
...
async def unban_user_cmd(message, chat, user, strings):
    ...
    if user_id == BOT_ID:
        await message.reply(strings["unban_Raya"])
        return
