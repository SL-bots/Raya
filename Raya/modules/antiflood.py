# Copyright (C) 2018 - 2020 SLBotsOfficial. All rights reserved. Source code available under the AGPL.
...
from Raya.modules.utils.connections import chat_connection
from Raya.modules.utils.language import get_strings, get_strings_dec
from Raya.modules.utils.message import (
    InvalidTimeUnit,
    convert_time,
    get_args,
    need_args_dec,
)
from Raya.modules.utils.restrictions import ban_user, kick_user, mute_user
from Raya.modules.utils.user_details import get_user_link, is_user_admin
from Raya.services.mongo import db
from Raya.services.redis import bredis, redis
from Raya.utils.cached import cached
from Raya.utils.logger import log
...
Raya: <code>Please send expiration time [...]</code>
